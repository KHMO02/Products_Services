...
async function authenticate(req, res, next) {
  ...
  try {
    ...
    const response = await axios.post(`http://${process.env.AUTH_HOST}:${process.env.AUTH_PORT}/auth/verify-token`, { token }); // Adjust the endpoint and request body as needed
